...
namespace _20191121_SP
{
    public partial class FrmSistemaSolar : Form
    {
        ...
        {
            //this.Text=this.Text.EstadoSimulacion()
        ...
        private void btnSimular_Click(object sender, EventArgs e)
        {
            if (this.animaciones.Count == 0)
            {
                ...
                {
                    //item.AnimarSistemaSolar();
                    this.animaciones.Add(new Thread(item.AnimarSistemaSolar));
                    this.animaciones[this.animaciones.Count - 1].Start();
                }
        ...
        {
            // Cancelar hilos
            for (int i = 0; i < this.animaciones.Count; i++)
            {
                this.animaciones[i].Abort();
            }
        ...
        private void DibujarAvancePlaneta(object sender, PlanetaEventArgs e)
        {
            ...
            {
                Planeta.InformacionDeAvance recall = new Planeta.InformacionDeAvance(DibujarAvancePlaneta);
